      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl">
          <form onSubmit={handleSubmit} className="border-2 border-white rounded-2xl mt-10 mx-auto p-6 sm:p-8 bg-slate-800">
            <h1 className="mb-6 text-2xl sm:text-3xl text-cyan-500 text-center font-semibold">Sign Up</h1>
            <div>
              <label htmlFor="" className="text-base sm:text-lg ml-2 block">Name</label>
            </div>
            <div>
            ...
            <div className='mt-3 '>
              <p className=''> have an account <Link to={'/'} className='text-blue-500 "text-blue-500 hover:underline"'>Login here </Link></p>
            </div>
          </form>
        </div>
      </div>
